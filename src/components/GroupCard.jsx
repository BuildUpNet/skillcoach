export default function GroupCard({ group, onLeave, onOpen }) {
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-3xl bg-white shadow-[0_2px_4px_rgba(20,26,24,.04),0_20px_40px_-28px_rgba(20,26,24,.3)] ring-1 ring-line transition-transform duration-300 hover:-translate-y-1">
      <div className="relative h-44 overflow-hidden">
        ...
        <h3 className="absolute bottom-4 left-5 right-5 text-[24px] font-extrabold leading-tight tracking-tight text-white">
          {group.name}
        </h3>
      </div>
